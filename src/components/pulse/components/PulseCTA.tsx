      ...
      <div className="container px-6 md:px-8 mx-auto">
        ...
        >
          ...
          <div className="absolute -top-6 -right-6">
            <Star className="w-12 h-12 text-orange-500 opacity-30" fill="currentColor" />
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-gray-300 md:text-lg max-w-3xl mx-auto mb-8">
              Partner with Pulse and transform how your audience experiences your brand. We'll help you create authentic connections through strategic storytelling and digital innovation.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mt-10">
              <Button
                ...
                onClick={() => {
                  ...
                  a.href = 'mailto:services@cafecruisers.in';
                  a.click();
                }}
              >
                {/* <Link href="/contact"> */}
              ...
              <Button
                variant="outline"
                size="lg"
                className="rounded-full px-8 border-orange-500/30 hover:border-orange-500/60 text-gray-200 hover:bg-orange-500/10"
                asChild
              >
                {/* <Link href="/pulse#services">
                  Explore Services
                </Link> */}
              </Button>
            </div>
