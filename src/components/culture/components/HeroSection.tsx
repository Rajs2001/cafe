...
export const HeroSection = () => {
  ...
  return (
    <section className="relative w-full h-screen max-h-[800px] overflow-hidden bg-gradient-to-b from-black to-zinc-900 flex items-center justify-center">
      ...
      <div className="container px-4 relative z-10">
        <div className="flex flex-col items-center">
          <motion.h1
            className="text-5xl md:text-7xl font-bold mb-6 text-center text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-orange-600 leading-tight"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8 }}
          >
            DRIVEN BY PASSION.<br />FUELED BY PURPOSE.
          </motion.h1>
          
          <motion.div
            className="w-40 h-1 bg-gradient-to-r from-orange-500 to-amber-600 mb-8"
            initial={{ scaleX: 0 }}
            animate={{ scaleX: 1 }}
          ...
          <motion.p
            className="text-gray-300 text-lg md:text-xl mb-6 max-w-2xl text-center"
            initial={{ opacity: 0 }}
            animate={{ opacity: 0.8 }}
